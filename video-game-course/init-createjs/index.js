...
(function(window, createjs) {
  ...
  background.graphics.beginFill('#CCC').drawRect(0, 0, canvas.width, canvas.height)
  ...
  circle1.graphics.beginFill('green').drawCircle(0, 0, radius)
  circle2.graphics.beginFill('pink').drawCircle(0, 0, radius)
